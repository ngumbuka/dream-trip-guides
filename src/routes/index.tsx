  ...
  head: () => ({
    meta: [
      { title: "VoyageonsEnsemble — Mobilité internationale, sans stress" },
      {
        name: "description",
        content:
          "Études, visas, courts et longs séjours, visite du Cameroun : nous gérons toute la logistique de votre voyage.",
      },
  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        ...
        {/* Services CTA */}
        <div
          className="mt-10 overflow-hidden rounded-2xl px-6 py-5 md:px-8 md:py-6"
          ...
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Décrivez-nous votre situation — réponse sous 24h avec une proposition personnalisée.
              </p>
            </div>
            <Link
              to="/new-request"
        ...
        >
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Link
              to="/new-request"
              search={{ service: undefined }}
              className="inline-flex items-center gap-2 rounded-full px-8 py-4 text-sm font-semibold text-white"
              style={{ backgroundColor: "var(--brand-red)" }}
            >
              <Rocket className="h-4 w-4" /> Démarrer mon projet <ArrowRight className="h-4 w-4" />
            </Link>
