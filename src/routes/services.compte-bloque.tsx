...
export const Route = createFileRoute("/services/compte-bloque")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ouverture de compte bloqué (Sperrkonto, AVI) pour répondre aux exigences financières des visas étudiants." },
    ],
  }),
  component: () => (
    <ServiceDetail
      ...
      steps={[
        { title: "Dossier", desc: "Nous rassemblons votre pièce d'identité et lettre d'admission." },
      ...
      faqs={[
        { q: "Comment récupérer mon argent une fois sur place ?", a: "À votre arrivée, vous ouvrez un compte courant local. L'organisme transfère chaque mois la somme prévue (ex: 934€/mois pour l'Allemagne)." },
        { q: "Quels sont les frais de service ?", a: "En plus du montant bloqué, l'organisme financier facture des frais de mise en place (souvent entre 50€ et 150€) que nous incluons dans le devis transparent." },
      ]}
