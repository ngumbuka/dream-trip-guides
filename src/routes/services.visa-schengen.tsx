...
export const Route = createFileRoute("/services/visa-schengen")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Visa Schengen pour la France, la Belgique, l'Allemagne et l'espace européen : constitution du dossier, prise de rendez-vous, suivi jusqu'à l'obtention." },
  ...
  component: () => (
    <ServiceDetail
      ...
      steps={[
        { title: "Bilan d'éligibilité", desc: "Nous vérifions votre profil et listons les pièces à rassembler." },
        { title: "Préparation dossier", desc: "Constitution complète, lettres et réservations conformes aux exigences." },
        { title: "Rendez-vous", desc: "Prise de rendez-vous au centre VFS / TLS et préparation à l'entretien." },
        { title: "Suivi & retrait", desc: "Suivi du traitement et récupération du passeport visé." },
      ]}
      included={[
        { icon: FileText, t: "Audit dossier" },
        { icon: Stamp, t: "Réservations VFS" },
        { icon: CalendarCheck, t: "Rendez-vous" },
        { icon: ShieldCheck, t: "Assurance voyage", to: "/services/caution-avi" },
        { icon: Headphones, t: "Assistance", to: "/services/accueil-integration" },
      ]}
      faqs={[
        { q: "Quel délai pour obtenir un visa Schengen ?", a: "Entre 2 et 6 semaines selon le consulat et la saison. Démarrez 6 à 8 semaines avant le départ." },
        { q: "Pouvez-vous garantir l'obtention ?", a: "La décision appartient au consulat. Un dossier solide maximise vos chances — nous refusons d'accompagner les dossiers manifestement non éligibles." },
        { q: "Quels pays sont couverts ?", a: "Les 27 États de l'espace Schengen, dont France, Belgique, Allemagne, Espagne, Italie, Portugal, Pays-Bas." },
        { q: "Et si mon visa est refusé ?", a: "Nous analysons le motif et préparons gratuitement le recours ou une nouvelle demande." },
      ]}
