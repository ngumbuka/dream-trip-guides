      ...
      <div className="mt-4 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {client?.full_name ?? client?.email ?? "Client"} · {client?.email} ·{" "}
            {client?.phone ?? "—"}
          </p>
        </div>
      ...
      <section className="mt-10">
        ...
        >
          <textarea
            ...
            className="w-full rounded-lg border border-border bg-white px-3 py-2 text-sm outline-none focus:border-foreground"
          />
