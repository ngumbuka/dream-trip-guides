  ...
  head: () => ({
    meta: [
      { title: "Visit Africa — Circuits & séjours | VoyageonsEnsemble" },
      {
        name: "description",
        content:
          "Découvrez l'Afrique : Sénégal, Côte d'Ivoire, Cap-Vert, Kenya, Rwanda, Tanzanie, Égypte, Maroc, Ouganda, Afrique du Sud, Ghana, Cameroun…",
      },
      { property: "og:title", content: "Visit Africa — VoyageonsEnsemble" },
      {
        property: "og:description",
        content: "Safaris, plages, déserts, métropoles : l'Afrique sur mesure.",
      },
  ...
  component: () => (
    <ServiceDetail
      ...
      steps={[
        {
          title: "Votre envie",
          desc: "On échange sur vos dates, vos envies et le rythme souhaité.",
        },
        {
          title: "Itinéraire",
          desc: "Nous concevons un programme personnalisé, validé avec vous.",
        },
        {
          title: "Logistique",
          desc: "Vols internes, visas pays, hôtels, chauffeurs et activités réservés.",
        },
      ...
      faqs={[
        {
          ...
          a: "Sénégal, Côte d'Ivoire, Cap-Vert, Kenya, Rwanda, Tanzanie, Égypte, Maroc, Ouganda, Afrique du Sud, Ghana, Cameroun et plus encore. Multi-pays possible sur un même séjour.",
        },
        {
          q: "Faut-il un visa pour chaque pays ?",
          a: "Cela dépend de votre nationalité. Beaucoup de pays proposent des e-visas ou un visa à l'arrivée. Nous gérons toutes les démarches pour vous.",
        },
        {
          q: "Quand partir ?",
          a: "Toute l'année selon la région : saison sèche pour les safaris (juin-octobre en Afrique de l'Est), hiver pour le Maroc et l'Égypte, novembre-février pour l'Afrique de l'Ouest.",
        },
        {
          q: "Organisez-vous des voyages de groupe ?",
          a: "Oui — familles, amis, associations, entreprises, retours au pays en groupe diaspora.",
        },
        {
          q: "Quelles vaccinations sont nécessaires ?",
          a: "Fièvre jaune obligatoire pour la plupart des pays subsahariens. Antipaludéen recommandé selon la zone. Nous vous remettons un guide santé par destination.",
        },
      ]}
