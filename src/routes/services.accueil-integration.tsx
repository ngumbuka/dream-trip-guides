...
export const Route = createFileRoute("/services/accueil-integration")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Accueil aéroport, démarches administratives et programme d'intégration : votre arrivée se passe dans les meilleures conditions." },
  ...
  component: () => (
    <ServiceDetail
      ...
      steps={[
        { title: "Avant l'arrivée", desc: "Échange visio pour préparer votre installation et confirmer l'agenda d'accueil." },
        { title: "Jour J", desc: "Accueil à l'aéroport, transfert et remise des clés de votre logement." },
        { title: "Première semaine", desc: "Démarches administratives prioritaires : campus, banque, transport, santé." },
      ...
      faqs={[
        { q: "À quelle heure pouvez-vous m'accueillir à l'aéroport ?", a: "Notre service fonctionne 7j/7 et s'adapte à votre vol, y compris en arrivée tardive ou matinale." },
        { q: "Quelles démarches sont prioritaires en arrivant ?", a: "L'inscription au campus, l'ouverture de compte bancaire, la validation du visa et la souscription à la sécurité sociale." },
