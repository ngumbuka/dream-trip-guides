  ...
  component: () => (
    <ServiceDetail
      ...
      faqs={[
        ...
        { q: "Quels sont les délais à prévoir ?", a: "Comptez de 2 semaines à 9 mois entre le démarrage du projet et le départ, en fonction du projet de voyage et de la destination." },
        { q: "Comment se passent les paiements ?", a: "Devis personnalisé après le bilan, paiement échelonné par étape clé." },
        { q: "Puis-je travailler pendant mes études ?", a: "Oui dans tous nos pays partenaires : 964 h/an en France, 24 h/semaine au Canada, 140 jours/an en Allemagne, 20 h/semaine en Belgique." },
        { q: "Quel niveau de langue est requis ?", a: "Variable selon le pays et la formation : B2 français pour la France, B1/B2 allemand ou anglais pour l'Allemagne, IELTS/TOEFL pour le Canada anglophone. Nous proposons des formations linguistiques dédiées." },
        { q: "Que se passe-t-il si mon visa est refusé ?", a: "Nous analysons le motif, préparons gratuitement un recours gracieux et/ou un nouveau dossier renforcé pour la session suivante." },
        { q: "Proposez-vous un accompagnement après l'arrivée ?", a: "Oui : accueil aéroport, ouverture de compte bancaire, sécurité sociale, démarches CAF/APL, premier mois sur place avec un référent local." },
      ]}
