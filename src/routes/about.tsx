      ...
      <section className="border-b border-border" style={{ backgroundColor: "var(--brand-cream)" }}>
        <div className="mx-auto max-w-5xl px-6 py-24 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            VoyageonsEnsemble est née de l'histoire de deux jeunes ambitieux qui, après avoir
            affronté les défis de l'intégration en France, ont décidé d'aider les autres à surmonter
            ces mêmes obstacles.
          </p>
        </div>
      </section>
        ...
        {[
          {
            icon: Compass,
            title: "Vision",
            text: "Devenir le partenaire de référence de la mobilité internationale pour les étudiants et professionnels francophones.",
          },
          {
            icon: Target,
            title: "Mission",
            text: "Simplifier les démarches, ouvrir des opportunités et offrir une tranquillité d'esprit inégalée à chaque voyageur.",
          },
          {
            icon: Heart,
            title: "Valeurs",
            text: "Bienveillance, transparence, exigence et proximité — à chaque étape du parcours.",
          },
        ].map((b) => (
      ...
      <section className="py-24" style={{ backgroundColor: "var(--brand-cream)" }}>
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="mt-3 text-4xl font-semibold md:text-5xl">
            Les visages derrière VoyageonsEnsemble.
          </h2>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            <article className="rounded-3xl bg-white p-10 shadow-sm">
              ...
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Titulaire d'un master en Comptabilité et Finance, Jacques s'est spécialisé en France
                en finance d'entreprise et banque d'investissement. Confronté aux défis
                administratifs et culturels à son arrivée, il a aidé gratuitement de nombreux
                étudiants à trouver logement et orientation — découvrant ainsi une véritable
                vocation.
              </p>
            </article>
            <article className="rounded-3xl bg-white p-10 shadow-sm">
              ...
              <p className="mt-4 leading-relaxed text-muted-foreground">
                Entrepreneur passionné, Benito a exploré plusieurs secteurs avant de se former en
                marketing international en France. Son goût pour le relationnel et le service client
                l'a naturellement conduit à co-fonder une structure d'accompagnement bienveillante
          ...
          <div className="mt-12 rounded-3xl border border-border bg-white p-10">
            ...
            <p className="mt-4 max-w-3xl leading-relaxed text-muted-foreground">
              VoyageonsEnsemble est une entreprise reconnue, animée par une équipe de plus de trente
              collaborateurs. Des experts en orientation académique, recherche de logement et
              gestion administrative travaillent chaque jour avec passion pour rendre chaque
              parcours plus serein. Chaque étape compte — nous sommes là pour vous guider.
            </p>
          </div>
        </div>
      </section>
          ...
          {[
            {
              ...
              email: "paris@voyageonsensemble.com",
            },
            {
              city: "Douala",
              addr: "Cameroun · Afrique",
              phone: "+237 6 00 00 00 00",
              email: "douala@voyageonsensemble.com",
            },
          ].map((o) => (
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        ...
        >
          ...
          <p className="mx-auto mt-3 max-w-xl text-muted-foreground">
            Notre équipe est prête à vous accompagner, de la première question à l'arrivée sur
            place.
          </p>
